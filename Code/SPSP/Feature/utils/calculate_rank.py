...
ALGORITHM_DIR_MAP = {
    ...
    'NSGA2': os.path.abspath('../../../../Results/RQ1-raw-data/SPSP')
}
...
def read_non_ft_best_nsga2_data(selected_datasets, start_seed, end_seed, output_path=None):
    ...
    for file in os.listdir(nsga2_dir):
        ...
        dataset_name = nsga2_pattern[0].strip('inst-')
        seed = int(nsga2_pattern[1])
        mode = nsga2_pattern[2]
...
def main():
    config = {
        ...
        'ranking_filename': 'non_ft_modes_ranking_spsp.csv',
    }
