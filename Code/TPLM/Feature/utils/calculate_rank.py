...
migration_rules = [
    "migrationRule1", "migrationRule2", "migrationRule3", "migrationRule4",
    "migrationRule5", "migrationRule7", "migrationRule8", "migrationRule10", "migrationRule18"
]
input_folders = ['ALL', 'CO', 'MS', 'DS']
selected_datasets = []
for rule in migration_rules:
    for folder in input_folders:
        if rule == "migrationRule3" and folder == "DS":
            continue
        dataset = f"{rule}_{folder}"
        selected_datasets.append(dataset)

MAXIMIZATION_DATASETS_FT = selected_datasets

ALGORITHM_DIR_MAP = {
    'NSGA2': os.path.abspath('../../../../Results/RQ1-raw-data/TPLM')
}
...
def main():
    config = {
        ...
        'ranking_filename': 'non_ft_modes_ranking_tplm.csv',
    }
    migration_rules = [
        "migrationRule1", "migrationRule2", "migrationRule3", "migrationRule4",
        "migrationRule5", "migrationRule7", "migrationRule8", "migrationRule10", "migrationRule18"
